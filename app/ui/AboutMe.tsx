...
//   return (
//     <>
//       <h1 className="about-me mb-8 text-4xl	">
//         Hi, I am
//         {` `}<button
//           type="button"
//           data-state="closed"
...
//         .
//         <span
//           data-state={`${toggleOpen ? "open" : "closed"}`}
...
//           className={`reveal-content`}
//         >
//           to create fast and efficient automated marketing campaigns. I live in
...
function AboutMeIntro() {
  ...
  return (
    <>
      <h1 className="about-me mb-8 text-4xl home-text	">
        Hi, I am{" "}
        <button
          type="button"

...
const IntroductionGrid: React.FC<IntroductionGridProps> = ({
  ...
  return (
    <section className="hero-section mt-16 pb-32 pt-16 mx-auto w-full px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem]">
      ...
      <div className="my-role isolate mt-24 grid grid-cols-1 border border-black/[.075]  sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <li className="flex w-full flex-none flex-col items-start border-t border-[#000]  px-6 py-8 sm:ml-[50%] sm:w-1/2 sm:border-l sm:border-t-0 lg:ml-[25%] lg:w-1/4">
            <h3 className="mt-6 text-sm font-medium">My Role</h3>
            <p className="mt-2 mb-auto text-gray-400 text-sm/5">
              {roleContent[1]}
            </p>
          </li>
          <li className="flex w-full flex-none flex-col items-start border-t border-[#000]   px-6 py-8 sm:w-1/2 lg:w-1/4 lg:border-l lg:border-t-0">
            <h3 className="mt-6 text-sm font-medium">Team Structure</h3>
            <p className="mt-2 mb-auto text-gray-400 text-sm/5">
              {teamContent.join(', ')}
            </p>
          </li>
          <li className="flex w-full flex-none flex-col items-start border-t border-[#000]   px-6 py-8 sm:w-1/2 sm:border-l lg:w-1/4 lg:border-t-0">

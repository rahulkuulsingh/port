    ...
    <>
      <section className="lg:max-w-[64rem] md:max-w-[48rem] md:px-8 mt-16 mx-auto pt-16 pb-8 px-6 relative sm:max-w-[40rem] w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <h2 className="text-9xl col-start-1 row-start-1 col-span-2">I design interfaces for people around the globe.</h2>
          <Image src={headShot} alt="an image that displays a motor" className="col-start-1 row-start-1 col-span-2"/>
        </div>
        </section>
